                ...
                <Tab eventKey="deposit" title="Deposit">
                  ...
                  <br></br>
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <button type='submit' className='btn btn-primary'  onClick={(input) => this.deposit(input)}>DEPOSIT</button>
                    </form>
                ...
                <Tab eventKey="borrow" title="Borrow">
                  ...
                  <br></br>
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <button type='submit' className='btn btn-primary' onClick={(input) => this.borrow(input)}>BORROW</button>
                    </form>
                  </div>
                </Tab>
